...
var require_base64url = __commonJS({
  "node_modules/base64url/dist/base64url.js"(exports2) {
    ...
    function decode(base64url19, encoding) {
      if (encoding === void 0) {
        encoding = "utf8";
      }
      return Buffer.from(toBase64(base64url19), "base64").toString(encoding);
    }
    function toBase64(base64url19) {
      base64url19 = base64url19.toString();
      return pad_string_1.default(base64url19).replace(/\-/g, "+").replace(/_/g, "/");
    }
    function fromBase64(base64) {
      return base64.replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_");
    }
    function toBuffer2(base64url19) {
      return Buffer.from(toBase64(base64url19), "base64");
    }
    var base64url18 = encode;
    base64url18.encode = encode;
    base64url18.decode = decode;
    base64url18.toBase64 = toBase64;
    base64url18.fromBase64 = fromBase64;
    base64url18.toBuffer = toBuffer2;
    exports2.default = base64url18;
  }
});
...
var require_utils = __commonJS({
  "node_modules/arweave/node/lib/utils.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.concatBuffers = concatBuffers2;
    exports2.b64UrlToString = b64UrlToString;
    exports2.bufferToString = bufferToString;
    exports2.stringToBuffer = stringToBuffer2;
    ...
    function concatBuffers2(buffers) {
      let total_length = 0;
    ...
    function stringToB64Url(string) {
      return bufferTob64Url(stringToBuffer2(string));
    }
  ...
  "node_modules/arweave/node/lib/crypto/node-driver.js"(exports2) {
    ...
    var NodeCryptoDriver = class {
      ...
      sign(jwk, data, { saltLength } = {}) {
        return new Promise((resolve, reject) => {
          resolve(crypto3.createSign(this.hashAlgorithm).update(data).sign({
      ...
      verify(publicModulus, data, signature) {
        return new Promise((resolve, reject) => {
          ...
          const verify3 = crypto3.createVerify(this.hashAlgorithm);
          verify3.update(data);
          const verifyResult = verify3.verify({
            key: keyObject,
            padding: crypto3.constants.RSA_PKCS1_PSS_PADDING
          }, signature);
          if (!verifyResult) {
            const details = {
              ...
              modulusLength: (_a = keyObject.asymmetricKeyDetails) == null ? void 0 : _a.modulusLength
            };
...
N.B. ArweaveJS is only guaranteed to verify txs created using ArweaveJS.`);
      ...
      hash(data, algorithm = "SHA-256") {
        ...
        return new Promise((resolve, reject) => {
          resolve(crypto3.createHash(this.parseHashAlgorithm(algorithm)).update(data).digest());
        });
      }
      /**
      ...
      async encrypt(data, key, salt) {
        const derivedKey = crypto3.pbkdf2Sync(key, salt = salt ? salt : "salt", 1e5, 32, this.hashAlgorithm);
        const iv = crypto3.randomBytes(16);
        const cipher = crypto3.createCipheriv(this.encryptionAlgorithm, derivedKey, iv);
      ...
      async decrypt(encrypted, key, salt) {
        try {
          ...
          const decipher = crypto3.createDecipheriv(this.encryptionAlgorithm, derivedKey, iv);
  ...
  "node_modules/arweave/node/lib/merkle.js"(exports2) {
    ...
    async function generateLeaves(chunks) {
      return Promise.all(chunks.map(async ({ dataHash, minByteRange, maxByteRange }) => {
        return {
          type: "leaf",
          id: await hash(await Promise.all([hash(dataHash), hash(intToBuffer2(maxByteRange))])),
          dataHash,
          minByteRange,
          maxByteRange
        };
      ...
      if (node.type == "leaf") {
        return {
          ...
          proof: (0, utils_1.concatBuffers)([
            proof,
            node.dataHash,
            intToBuffer2(node.maxByteRange)
          ])
        };
      }
      if (node.type == "branch") {
    ...
    async function hashBranch(left, right) {
      ...
      let branch = {
        ...
        id: await hash([
          await hash(left.id),
          await hash(right.id),
          await hash(intToBuffer2(left.maxByteRange))
        ]),
...
var require_common = __commonJS({
  "node_modules/arweave/node/common.js"(exports2) {
    ...
    var api_1 = __importDefault(require_api2());
...
var require_deepHash = __commonJS({
  "node_modules/arweave/node/lib/deepHash.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.default = deepHash2;
    var common_1 = __importDefault(require_common());
    async function deepHash2(data) {
      if (Array.isArray(data)) {
...
var require_bindings2 = __commonJS({
  "node_modules/keccak/bindings.js"(exports2, module2) {
    module2.exports = require_api3()(require_node_gyp_build2()(__dirname));
  }
});
...
var require_tmp = __commonJS({
  "node_modules/tmp/lib/tmp.js"(exports2, module2) {
    ...
    function tmpName2(options, callback) {
    ...
    function file2(options, callback) {
      const args = _parseArguments(options, callback), opts = args[0], cb = args[1];
      tmpName2(opts, function _tmpNameCreated(err, name) {
        if (err) return cb(err);
    ...
    module2.exports.tmpName = tmpName2;
...
var require_tmp_promise = __commonJS({
  "node_modules/tmp-promise/index.js"(exports2, module2) {
    ...
    var fileWithOptions = promisify4(
      (options, cb) => tmp.file(
        options,
        (err, path, fd, cleanup) => err ? cb(err) : cb(void 0, { path, fd, cleanup: promisify4(cleanup) })
      )
    );
    ...
    var dirWithOptions = promisify4(
      (options, cb) => tmp.dir(
        options,
        (err, path, cleanup) => err ? cb(err) : cb(void 0, { path, cleanup: promisify4(cleanup) })
      )
    );
      ...
      constructor(streams, opts) {
        ...
        if (typeof streams === "function") {
          ...
          this._queue.forEach((stream2) => {
            if (typeof stream2 !== "function") this._attachErrorListener(stream2);
          });
        }
        this._next();
      }
...
var require_stream_chunker = __commonJS({
  "node_modules/stream-chunker/index.js"(exports2, module2) {
    var through2 = require_through2();
    module2.exports = function(chunkSize, opts) {
      if (!opts) opts = {};
...
// node_modules/arweave-stream-tx/dist/generate-transaction-chunks-async.js
var require_generate_transaction_chunks_async = __commonJS({
  "node_modules/arweave-stream-tx/dist/generate-transaction-chunks-async.js"(exports2) {
    "use strict";
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.generateTransactionChunksAsync = void 0;
    var arweave_1 = __importDefault(require_node2());
    var merkle_1 = require_merkle();
    var stream_chunker_1 = __importDefault(require_stream_chunker());
    ...
    exports2.generateTransactionChunksAsync = generateTransactionChunksAsync;
  }
});

// node_modules/arweave-stream-tx/dist/create-transaction-async.js
var require_create_transaction_async = __commonJS({
  "node_modules/arweave-stream-tx/dist/create-transaction-async.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod2) {
      return mod2 && mod2.__esModule ? mod2 : { "default": mod2 };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.createTransactionAsync = void 0;
    var transaction_1 = __importDefault(require_transaction());
    var utils_1 = require_utils();
    var promises_1 = require("stream/promises");
    var generate_transaction_chunks_async_1 = require_generate_transaction_chunks_async();
    function createTransactionAsync2(attributes, arweave, jwk) {
      return async (source) => {
        var _a, _b, _c;
    ...
    exports2.createTransactionAsync = createTransactionAsync2;
  }
});
...
// node_modules/arweave-stream-tx/dist/upload-transaction-async.js
var require_upload_transaction_async = __commonJS({
  "node_modules/arweave-stream-tx/dist/upload-transaction-async.js"(exports2) {
    "use strict";
    var __asyncValues = exports2 && exports2.__asyncValues || function(o) {
      if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
      var m = o[Symbol.asyncIterator], i;
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.uploadTransactionAsync = void 0;
    var merkle_1 = require_merkle();
    var utils_1 = require_utils();
    ...
    var MAX_CONCURRENT_CHUNK_UPLOAD_COUNT = 128;
    function uploadTransactionAsync2(tx, arweave, createTx = true) {
      return async (source) => {
        if (!tx.chunks) {
    ...
    exports2.uploadTransactionAsync = uploadTransactionAsync2;
  }
});

// node_modules/arweave-stream-tx/dist/index.js
var require_dist = __commonJS({
  "node_modules/arweave-stream-tx/dist/index.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    __exportStar(require_create_transaction_async(), exports2);
    __exportStar(require_generate_transaction_chunks_async(), exports2);
    __exportStar(require_upload_transaction_async(), exports2);
  }
});
...
__export(index_exports, {
  DEFAULT_GQL_ENDPOINT: () => DEFAULT_GQL_ENDPOINT,
  DEFAULT_HYPERBEAM_NODE_URL: () => DEFAULT_HYPERBEAM_NODE_URL,
  GQLUrls: () => GQLUrls,
  HB: () => HB
});
module.exports = __toCommonJS(index_exports);

// src/signer/browser.js
var import_buffer2 = __toESM(require_buffer());
var WarpArBundles = __toESM(require("warp-arbundles"));

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/keys/curve25519.js
var import_base64url = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/constants.js
var SignatureConfig;
(function(SignatureConfig2) {
  ...
  SignatureConfig2[SignatureConfig2["KYVE"] = 101] = "KYVE";
...
var ExtendedPoint = class _ExtendedPoint {
  ...
  isTorsionFree() {
    return this.multiplyUnsafe(CURVE.l).equals(_ExtendedPoint.ZERO);
  }
...
// node_modules/@dha-team/arbundles/build/node/esm/src/nodeUtils.js
var import_utils = __toESM(require_utils(), 1);
var import_node_driver = __toESM(require_node_driver(), 1);
var import_transaction = __toESM(require_transaction(), 1);
var import_node = __toESM(require_node2(), 1);
var driver = import_node_driver.default["default"] ? import_node_driver.default["default"] : import_node_driver.default;

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/keys/Rsa4096Pss.js
var import_base64url2 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/chains/ArweaveSigner.js
var import_pem = __toESM(require_pem3(), 1);
var import_base64url3 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/chains/injectedSolanaSigner.js
var import_base64url4 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/chains/SolanaSigner.js
var import_bs58 = __toESM(require_bs58(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/keys/secp256k1.js
var import_base64url5 = __toESM(require_base64url2(), 1);
var import_secp256k1 = __toESM(require_secp256k12(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/keccak256.js
...
function bigintToBuffer(value) {
  ...
  return import_buffer.Buffer.from(padToEven(hex), "hex");
}
if (typeof window !== "undefined") {
  window.keccak256 = keccak256;
}

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/chains/ethereumSigner.js
var import_secp256k13 = __toESM(require_secp256k12(), 1);
var import_base64url6 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/signing/chains/arconnectSigner.js
var import_base64url7 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/Bundle.js
var import_base64url9 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/DataItem.js
var import_base64url8 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/ar-data-create.js
var import_base64url10 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/stream/index.js
var import_base64url11 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/file/bundleData.js
var import_tmp_promise = __toESM(require_tmp_promise(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/file/FileDataItem.js
var import_base64url12 = __toESM(require_base64url2(), 1);
var import_fs = require("fs");
var import_util = require("util");
var read = (0, import_util.promisify)(import_fs.read);
var write = (0, import_util.promisify)(import_fs.write);

// node_modules/@dha-team/arbundles/build/node/esm/src/file/FileBundle.js
var import_fs2 = require("fs");
var import_multistream = __toESM(require_multistream(), 1);
var import_arweave_stream_tx = __toESM(require_dist(), 1);
var import_util2 = require("util");
var import_base64url13 = __toESM(require_base64url2(), 1);
var read2 = (0, import_util2.promisify)(import_fs2.read);

// node_modules/@dha-team/arbundles/build/node/esm/src/file/createData.js
var import_tmp_promise2 = __toESM(require_tmp_promise(), 1);
var import_base64url14 = __toESM(require_base64url2(), 1);

// node_modules/@dha-team/arbundles/build/node/esm/src/file/file.js
var import_fs3 = require("fs");
var import_util3 = require("util");
var import_base64url15 = __toESM(require_base64url2(), 1);
var read3 = (0, import_util3.promisify)(import_fs3.read);

// src/signer/browser.js
var import_base64url16 = __toESM(require_base64url2());
var { DataItem } = WarpArBundles;
...
async function getRawAndId(dataItemBytes) {
  ...
  return {
    id: import_base64url16.default.encode(import_buffer2.Buffer.from(rawId)),
    raw: dataItem.getRaw()
  };
}
function createANS104Signer(arweaveWallet2) {
  const signer = async (create) => arweaveWallet2.connect([
    "SIGN_TRANSACTION"
  ]).then(async () => {
    ...
    const res = await getRawAndId(import_buffer2.Buffer.from(view));
    return res;
  });
  return signer;
}
function createHttpSigner(arweaveWallet2) {
  const signer = async (create) => arweaveWallet2.connect([
    "ACCESS_ADDRESS",
    "ACCESS_PUBLIC_KEY",
    "SIGNATURE"
    ...
    const [publicKey, address] = await Promise.all([
      arweaveWallet2.getActivePublicKey(),
      arweaveWallet2.getActiveAddress()
    ]);
    ...
    const view = await arweaveWallet2.signMessage(
      signatureBase,
      { hashAlgorithm: "SHA-512" }
    );
    return {
      signature: import_buffer2.Buffer.from(view),
      address
    };
  });
  return signer;
...
var toDataItemSigner = (signer) => {
  const DATAITEM_SIGNER_KIND2 = "ans104";
  const HTTP_SIGNER_KIND2 = "httpsig";
  return async ({ data, tags, target, anchor }) => {
    ...
    const create = async (injected) => {
      ...
      const deepHash2 = await getSignatureData(unsigned);
      return deepHash2;
    };
    return signer(create, DATAITEM_SIGNER_KIND2).then((res) => {
      if (!createCalled) {
...
var DEFAULT_HYPERBEAM_NODE_URL = "https://forward.computer";
...
var HB = class {
  constructor(params = {}) {
    ...
    this.authority = params == null ? void 0 : params.authority;
  }
  ...
  getAuthority = async function() {
    ...
    if (authority === "undefined" || authority === void 0) {
      if (url === "https://forward.computer") {
        authority = "QWg43UIcJhkdZq6ourr1VbnkwcP762Lppd569bKWYKY";
      } else {
        authority = await this.fetch("/~meta@1.0/info/address").then((r) => r.text());
      }
  ...
  spawn = async function(name, data, wallet) {
    try {
      ...
      let params = {
        ...
        "aos-version": "2.0.7",
        // from aos-cli pkg.version
        "accept-bundle": "true",
        // note: added to header automatically
        "codec-device": "ans104@1.0",
        "signingformat": "ANS-104",
        "scheduler": scheduler,
        "scheduler-location": scheduler,
        "Module": "xVcnPK8MPmcocS6zwq1eLmM2KhfyarP8zzmz3UVi1g4",
        // from aos-cli pkg.hyper.module
        "data": data
      };
  ...
  result = async function(fields = {}, params) {
    try {
      const { process: process2, message, slot } = fields;
      if (!process2) {
        throw new Error("missed process id.");
      }
      if (!message && !slot) {
        throw new Error("missed message or slot.");
      }
      let url = this.url || DEFAULT_HYPERBEAM_NODE_URL;
      let path = `/${process2}~process@1.0/compute=${slot || message}/results`;
      ...
      }).then((res) => (res == null ? void 0 : res.ok) && (res == null ? void 0 : res.json()));
    } catch (error) {
      throw error;
    }
  };
