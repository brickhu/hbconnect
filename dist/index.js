...
var import_browser = require("@permaweb/aoconnect/browser");
...
var HB = class {
  constructor(params = {}) {
    ...
    this.url = url || DEFAULT_HYPERBEAM_NODE_URL || import_meta.env.VITE_HYPERBEAM_URL;
  ...
  send = async function(fields, wallet) {
    try {
      ...
      let signer = (0, import_browser.createSigner)(wallet || this.wallet);
